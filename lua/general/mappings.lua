...
vim.keymap.set('n', '<Leader>fcf', ':Telescope current_buffer_fuzzy_find<CR>', opts)
vim.keymap.set('n', '<Leader>fg', ':Telescope git_files<CR>', opts)
vim.keymap.set('n', '<Leader>fb', ':Telescope buffers<CR>', opts)
vim.keymap.set('n', '<Leader>fh', ':Telescope search_history<CR>', opts)
vim.keymap.set('n', '<Leader>fm', ':Telescope marks<CR>', opts)
vim.keymap.set('n', '<Leader>ft', ':Telescope tags<CR>', opts)
vim.keymap.set('n', '<Leader>fa', ':Telescope live_grep<CR>', opts)


------------------ BUN MAPPINGS --------------

--Run current JS/TS files
vim.keymap.set('n', '<Leader>br', ':!bun run %<CR>', opts)

--Save file and run current JS/TS files
vim.keymap.set('n', '<Leader>wbr', ':w <bar> :!bun run %<CR>', opts)
